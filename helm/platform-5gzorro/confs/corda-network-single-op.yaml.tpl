...
network:
  ...
  network_services:
    - service:
      ...
      certificate: /home/certs/doorman/tls/ambassador.crt
    - service:
      type: networkmap
      uri: "https://networkmap.{{ .Values.cordaBevel.url_suffix }}"
      certificate: /home/certs/networkmap/tls/ambassador.crt
  ...
  organizations:
    - organization:
      ...
      state: London
      location: London
      subject: "O=Trader2,OU=Trader2,L=London,C=GB"
      type: node
      ...
      services:
        ...
        - peer:
          name: trader2
          subject: "O=Trader2,OU=Trader2,L=51.50/-0.13/London,C=GB" # This is the node subject. L=lat/long is mandatory for supplychain sample app
          type: node
          p2p:
            port: 10002
            targetPort: 10002
